...
#elif (__APPLE__ || linux) && !defined(__ANDROID__)
#include <execinfo.h>
#include <signal.h>
#include <unistd.h>
#endif
...
void fatal_error(const char* fmt, ...) {
    ...
    // NDK ships backtrace as a stub. Skip stack trace — SDL_Log →
    // __android_log_print → logcat covers it.
    fprintf(stderr, "Stack trace unavailable on Android (use adb logcat).\n");
