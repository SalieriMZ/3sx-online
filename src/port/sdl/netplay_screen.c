...
#if IMGUI
static const bool use_imgui_netplay = true;
#else
static const bool use_imgui_netplay = false;
#endif
...
void NetplayScreen_Render() {
    ...
    if (fs != FISTBUMP_IDLE && fs != FISTBUMP_GAME_START) {
        ...
        case FISTBUMP_AWAITING_CREDENTIALS:
            // login_panel ImGui overlay owns these screens — no SF3 text.
            break;
